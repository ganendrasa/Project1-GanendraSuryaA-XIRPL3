...
public class MainAplikasiKasir {
    ...
    public void generateDaftarMenu() { 
        ...
        daftarMenu.tambahMenu (new Ramen("Ramen Daging", 28000));
        daftarMenu.tambahMenu (new Kuah("Kuah Original"));
        daftarMenu.tambahMenu (new Kuah("Kuah Tomyam"));
        ...
        daftarMenu.tambahMenu (new Minuman("Jus Stroberi", 10000));
        daftarMenu.tambahMenu (new Minuman("Espresso", 12000));
